...
class CurrentMovieFamily extends Family<MovieModel> {
  ...
  /// See also [currentMovie].
  CurrentMovieProvider call(int index) {
    return CurrentMovieProvider(index);
  }
...
class CurrentMovieProvider extends AutoDisposeProvider<MovieModel> {
  /// See also [currentMovie].
  CurrentMovieProvider(int index)
    : this._internal(
        (ref) => currentMovie(ref as CurrentMovieRef, index),
  ...
  @override
  Override overrideWith(MovieModel Function(CurrentMovieRef provider) create) {
...
class _CurrentMovieProviderElement
    extends AutoDisposeProviderElement<MovieModel>
    with CurrentMovieRef {
...
String _$moviesHash() => r'92db034b989b12ac5193136d63273c0cabc18aa9';

/// See also [Movies].
@ProviderFor(Movies)
final moviesProvider = NotifierProvider<Movies, MoviesState>.internal(
  Movies.new,
...
typedef _$Movies = Notifier<MoviesState>;
