...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoriteState&&const DeepCollectionEquality().equals(other.favoritesList, favoritesList));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(favoritesList));
...
/// Create a copy of FavoriteState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? favoritesList = null,}) {
  return _then(_self.copyWith(
favoritesList: null == favoritesList ? _self.favoritesList : favoritesList // ignore: cast_nullable_to_non_nullable
as List<MovieModel>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<MovieModel> favoritesList)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoriteState() when $default != null:
return $default(_that.favoritesList);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<MovieModel> favoritesList)  $default,) {final _that = this;
switch (_that) {
case _FavoriteState():
return $default(_that.favoritesList);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<MovieModel> favoritesList)?  $default,) {final _that = this;
switch (_that) {
case _FavoriteState() when $default != null:
return $default(_that.favoritesList);case _:
  return null;
...
class _FavoriteState implements FavoriteState {
   _FavoriteState({final  List<MovieModel> favoritesList = const []}): _favoritesList = favoritesList;
  

 final  List<MovieModel> _favoritesList;
@override@JsonKey() List<MovieModel> get favoritesList {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FavoriteState&&const DeepCollectionEquality().equals(other._favoritesList, _favoritesList));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_favoritesList));
...
/// Create a copy of FavoriteState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? favoritesList = null,}) {
  return _then(_FavoriteState(
favoritesList: null == favoritesList ? _self._favoritesList : favoritesList // ignore: cast_nullable_to_non_nullable
as List<MovieModel>,
  ));
}
